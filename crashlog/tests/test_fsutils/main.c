...
int main(int __attribute__((unused)) argc, char __attribute__((unused)) **argv) {
    ...
    */
    ...
    /* system("echo persist.vendor.sys.crashlogd.mode=lowmemory > res/properties.txt"); */
    ...
    /* system("echo persist.vendor.sys.crashlogd.mode=lowmemorrry > res/properties.txt"); */
    /* reset_property_cache(); */
    /* test_get_sdcard_paths(MODE_CRASH, 0); */
