...
#define CRASHLOG_SELECT_TIMEOUT 10
...
#define CRASHLOG_ERROR_RESET    "CRASHLOG_SELF_RESET"
...
#define RESET_EVNAME            "RESET_LOGS"
...
#define AID_SYSTEM_CRASHLOGD 1000
#define AID_LOG_CRASHLOGD    1007
#define AID_ROOT_CRASHLOGD      0
/* Struct defining a android id information
 * New attributes to be added when needed
 */
struct crashlogd_id_info {
    const char * name;
    unsigned aid;
};

/* Array defining for pids uids */
static const struct crashlogd_id_info crashlogd_ids[] = {
    {"root", AID_ROOT_CRASHLOGD},
    {"system", AID_SYSTEM_CRASHLOGD},
    {"log", AID_LOG_CRASHLOGD},
};
...
/* PROPERTIES */
#define PROP_DATA_QUOTA         "persist.vendor.crashlogd.data_quota"
#define PROP_LOGS_ROOT          "persist.vendor.crashlogd.root"
#define PROP_CRASH_MODE         "persist.vendor.sys.crashlogd.mode"
#define PROP_PROFILE            "persist.vendor.service.profile.enable"
#define PROP_PROC_ONGOING       "crashlogd.vendor.processing.ongoing"
#define PROP_BOOTREASON         "sys.boot.reason"
...
#define PROP_COREDUMP           "persist.vendor.core.enabled"
#define PROP_CRASH_MODE         "persist.vendor.sys.crashlogd.mode"
#define PROP_ANR_USERSTACK      "persist.vendor.anr.userstack.disabled"
#define PROP_IPANIC_PATTERN     "persist.vendor.crashlogd.panic.pattern"
#define PROP_APLOG_DEPTH        "persist.vendor.crashreport.aplogdepth"
#define PROP_APLOG_NB_PACKET    "persist.vendor.crashreport.packet"
#define PROP_LOGSYSTEMSTATE     "init.svc.vendor.logsystemstate"
...
#define PROP_REPORT_GENERIC_FAKE "persist.vendor.crashlogd.events.fake"
#define PROP_ISTP_CLEAN         "persist.vendor.crashlogd.istp_clean"
/** Control whether boot logs are stored. "1" disables boot logs. */
#define PROP_BOOT_LOG_DISABLED  "persist.vendor.crashlogd.no_bootlog"
#define LOGGER_PROP             "ro.vendor.intel.logger"
#define PROP_APLOG_ROT_CNT      "persist.vendor.intel.logger.rot_cnt"
...
#define CACHE_DIR               RESDIR "/cache/cache"
...
#define APLOG_FILE_0            APLOG_DIR "/aplog"
#define BPLOG_FILE_0            LOGS_DIR "/bplog"
#define BPLOG_FILE_EXT          ".istp"
...
#define APLOG_FILE_BOOT         APLOG_DIR "/aplog_boot"
...
#define LAST_VMM_LOG            "last_vmm_log"
#define LAST_VMM_LOG_FILE       LOGS_DIR "/" LAST_VMM_LOG
...
#define LOGGER_DEF_PATH         SYSTEM_DIR "/bin/logcat"
...
#define SSRAM_ATTR_FILE_NAME 	SYS_DIR "/devices/platform/INT34D2:00/ssrambase"
